    ...
    <div class="rf-container">
        ...
        <div class="rf-container-fluid">
            <div class="rf-grid-row rf-grid-row--gutters rf-grid-row--center">
              <div class="rf-col-12" style="text-align: center;">
               
              <div class="rf-callout rf-fi-information-line">
                <h3 class="rf-callout__title">Demande de visite à distance enregistrée !</h3>
                <p class="rf-callout__text">
               <br><br>
            <p class="lead">Une invitation va vous être rapidement envoyée. <br>
          L'équipe Histologe vous remercie.
                </p>
            </div> 
